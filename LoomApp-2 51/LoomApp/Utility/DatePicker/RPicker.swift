...
@objc open class RPicker: NSObject {
    ...
    @objc class func selectDate(title: String? = nil,
        ...
        guard let vc = controller(title: title, cancelText: cancelText, doneText: doneText, datePickerMode: datePickerMode, selectedDate: selectedDate, minDate: minDate, maxDate: selectedDate, type: .date, style: style) else { return }
...
class RPickerController: UIViewController {
    ...
    private let buttonColor = UIColor(red: 255/255, green: 88/255, blue: 1/255, alpha: 1)
